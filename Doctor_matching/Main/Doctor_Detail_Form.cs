...
namespace Main
{
    public partial class Doctor_Detail_Form : Form
    {
        ...
        public Doctor_Detail_Form(decimal PK, DoctorData select_doctor, List<DoctorData> DoctorDataList)
        {
        ...
        private void Doctor_Detail_Form_Load(object sender, EventArgs e)
        {
            hospital_label.Text = select_doctor.DoctorHospital;
            ...
            foreach (CommentData commentData in comment)
            {
                ...
                doctor_coment_view.Rows[rowIndex].Cells["conntent"].Value = commentData.CommentContent;
        ...
        {   
            Maching_Result_Form maching_result_form = new Maching_Result_Form(this.PK, this.DoctorDataList);
        ...
        private void hospital_detail_btn_Click(object sender, EventArgs e)
        {
            ...
            Hospital_Info_Form hospital_info_form = new Hospital_Info_Form(select_doctor.HospitalSerialNumber, PK, select_doctor,  DoctorDataList);
        ...
        {
            db.select_favorites(PK, select_doctor.DoctorSerialNumber);
        }
